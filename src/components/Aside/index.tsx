      ...
      <div className="aside-primary d-flex flex-column align-items-lg-center flex-row-auto">
        ...
        >
          <a href="../../demo7/dist/index.html">
            <img alt="Logo" src="assets/media/logos/logo-demo7.svg" className="h-35px" />
          </a>
        </div>
        {/*--end::Logo--*/}
        {/*--begin::Nav--*/}
        ...
        <div className="aside-footer d-flex flex-column align-items-center flex-column-auto" id="kt_aside_footer">
          ...
          <div className="d-flex align-items-center mb-10" id="kt_header_user_menu_toggle">
            ...
            >
              ...
              {/*--begin::Menu item--*/}
              <div className="menu-item px-5">
                <a href="../../demo7/dist/pages/projects/list.html" className="menu-link px-5">
              ...
              <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
                ...
                <div className="menu-sub menu-sub-dropdown w-175px py-4">
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/referrals.html" className="menu-link px-5">
                      Referrals
                    </a>
                  </div>
                  {/*--end::Menu item--*/}
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/billing.html" className="menu-link px-5">
                      Billing
                    </a>
                  </div>
                  {/*--end::Menu item--*/}
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/statements.html" className="menu-link px-5">
                      Payments
                    </a>
                  </div>
                  {/*--end::Menu item--*/}
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/statements.html" className="menu-link d-flex flex-stack px-5">
                      Statements
                      <i
              ...
              <div className="menu-item px-5" data-kt-menu-trigger="hover" data-kt-menu-placement="right-end">
                ...
                <div className="menu-sub menu-sub-dropdown w-175px py-4">
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/settings.html" className="menu-link d-flex px-5 active">
                  ...
                  {/*--begin::Menu item--*/}
                  <div className="menu-item px-3">
                    <a href="../../demo7/dist/account/settings.html" className="menu-link d-flex px-5">
                      <span className="symbol symbol-20px me-4">
              ...
              {/*--begin::Menu item--*/}
              <div className="menu-item px-5">
                <a href="../../demo7/dist/authentication/flows/basic/sign-in.html" className="menu-link px-5">
                  Sign Out
                </a>
              </div>
              {/*--end::Menu item--*/}
